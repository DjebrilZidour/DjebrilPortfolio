  ...
  return (
    <section id="contact" className="flex justify-center items-center  flex-col gap-16 border-2 m-4">
      ...
      <div className="flex justify-center items-center gap-4 w-full ">
        <div className="border-2 border-black flex justify-center items-center gap-4 flex-col p-4 w-1/2 ml-12 rounded-3xl">
          <h1>my phone number</h1>
          <h2>+213 556 94 65 14</h2>
        </div>
        <div className="border-2 border-black flex justify-center items-center gap-4 flex-col p-4 w-1/2 mr-12 rounded-3xl">
          <h1>my e-mail</h1>
