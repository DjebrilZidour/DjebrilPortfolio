const Contact = () => {
  return (
    <section id="contact" className="flex justify-center items-center  flex-col gap-8  m-4">
      ...
      <h1 className="text-3xl capitalize text-center">you can contact me by E-mail or phone number</h1>
      <div className="flex justify-center items-center flex-col  gap-4 w-full">
        <div className=" flex justify-center items-center flex-col  gap-4 md:px-44 py-4 bg-yellow-100 border-2 border-black rounded-2xl w-80 md:w-auto ">
        <h1 className="md:text-5xl text-3xl  uppercase">my phone number:</h1>
        <h2 className="md:text-5xl text-3xl  font-bold">+213 556 94 65 14</h2>
        </div>
