      ...
      <section className="flex justify-between items-center  my-8 home px-12 ">
        <div className="flex flex-col items-start justify-center w-1/2 gap-4">
          ...
          <a target="new" href="https://github.com/DjebrilZidour">
              <div  className="border px-4 py-2 hover:bg-red-500 hover:text-white rounded-xl text-2xl capitalize uppercase flex justify-center items-center gap-4 cursor-poiter">
