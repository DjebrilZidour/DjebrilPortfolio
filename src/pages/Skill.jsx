      ...
      >
        ...
        <div className="flex flex-col justify-center items-center md:items-start gap-4">
          ...
          <p className="md:w-96 md:text-2xl w-full md:text-start text-center px-16 ">
            ...
            magni temporibus recusandae dolorum dolore iusto, vitae aperiam,
            quaerat aliquam autem incidunt esse nobis enim voluptate, beatae
            praesentium adipisci reprehenderit. dont forget bootstrap to add it
          </p>
        </div>
